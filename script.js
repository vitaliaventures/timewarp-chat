...
if (seoDiv) {
  seoDiv.textContent =
  "Live public chat room for anonymous conversations. Messages disappear automatically. " +
  "No registration required. Join real-time discussions instantly and share the room link with anyone.";
}
